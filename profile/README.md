...
**STAR S.H.I.P.** bridges this gap by introducing an SMS-based data collection and AI chatbot system. By utilizing Natural Language Processing (NLP), we empower educators to build comprehensive digital profiles through the tools they already use—ensuring a future where every teacher is just one SMS away.

---

## Technology Stack

The team has developed a functional SMS AI chatbot prototype to prove project feasibility. To optimize performance and handle token limitations, the system utilizes an **Extract, Load, Transform (ELT)** data integration architecture.
...
* **Visualization:** Data is served to a **Leaflet.js Heatmap** and a tabulated information dashboard.
